#!/bin/bash
# Full startup: your working image/www fixes + HTTPS (Caddy).
...
if ss -tlnp 2>/dev/null | grep -q ':443 '; then
  echo "WARN: port 443 in use (sing-box?)"
